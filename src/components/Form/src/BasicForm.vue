...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props, { emit, attrs }) {
      ...
      const formCacheData = ref<Recordable>({test:1})
      ...
      const getProps = computed(() => {
        return {
          ...props,
          ...unref(propsRef),
          formCacheData: unref(formCacheData),
        } as FormProps;
      });
      ...
      function getFormCacheData() {
        return unref(formCacheData)
      }
